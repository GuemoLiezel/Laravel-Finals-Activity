...
controller class.<br>It no longer need to specify the method.</h2></p>
    ...
    <div class="content">
        <section id="section5">
            <h2 class="contact">You Can Contact Me <br><br> <i class="bi bi-facebook"> Facebook: https://www.facebook.com/liezel.guemo <br> <i class="bi bi-instagram"> Instagram: @_lilisel <br> <i class="bi bi-messenger"> Messenger: Liezel Guemo <br> <i class="bi bi-envelope-check"> Email: guemo_liezel@plpasig.edu.ph </i></i></i></i></h2>
        </section>
    </div>
